...
<div class="row t30">
    <div class="medium-4 columns zoom">
        <a href="https://www.enedis.fr/"><img src="{{ site.urlimg }}partnerlogos/Enedis.jpg" alt="Enedis" width="240" title="Enedis"></a>
    </div><!-- /.medium-4.columns -->
    <div class="medium-4 columns zoom">
        <a href="https://eref-europe.org/"><img src="{{ site.urlimg }}partnerlogos/EREF.jpg" alt="EREF" width="240" title="EREF European Renewable Energies Federation"></a>
    </div><!-- /.medium-4.columns -->
    <div class="medium-4 columns zoom">
...
<div class="row t30">
    ...
    <div class="medium-4 columns zoom">
        <a href="https://www.dtu.dk/"><img src="{{ site.urlimg }}partnerlogos/dtu.jpg" alt="Danmarks Tekniske Universitet (DTU)" width="240" title="Danmarks Tekniske Universitet (DTU)"></a>
    </div><!-- /.medium-4.columns -->
</div><!-- /.row -->
...
<div class="row t30">
    ...
    <div class="medium-4 columns">
        <a href="https://www.enercoutim.eu/"><img src="{{ site.urlimg }}partnerlogos/aelec.png" alt="" width="240" title="Aelec"></a>
    </div><!-- /.medium-4.columns -->
    <div class="medium-4 columns">
